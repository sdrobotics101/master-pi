...
MASTER_SERVER_ID = chr(42)
SENSOR_SERVER_ID = chr(43)
MOTOR_SERVER_ID = chr(44)
FORWARD_VISION_SERVER_ID = chr(45)
DOWNWARD_VISION_SERVER_ID = chr(46)
SONAR_SERVER_ID = chr(47)
